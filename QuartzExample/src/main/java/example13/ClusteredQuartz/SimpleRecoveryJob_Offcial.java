 ...
 * @author James House
 */
public class SimpleRecoveryJob_Offcial implements Job {

  private static Logger       _log  = LoggerFactory.getLogger(SimpleRecoveryJob_Offcial.class);
   ...
   */
  public SimpleRecoveryJob_Offcial() {
  }
