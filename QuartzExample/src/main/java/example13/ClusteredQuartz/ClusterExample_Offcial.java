 ...
 * </p>
 * 
 * @see SimpleRecoveryJob_Offcial
 * @see SimpleRecoveryStatefulJob_Offcial
 * @author James House
 */
public class ClusterExample_Offcial {

  private static Logger _log = LoggerFactory.getLogger(ClusterExample_Offcial.class);
  ...
  public void run(boolean inClearJobs, boolean inScheduleJobs) throws Exception {
    ...
    if (inScheduleJobs) {
      ...
      JobDetail job = newJob(SimpleRecoveryJob_Offcial.class).withIdentity("job_" + count, schedId) // put triggers in group
      ...
      job = newJob(SimpleRecoveryJob_Offcial.class).withIdentity("job_" + count, schedId) // put triggers in group named after
      ...
      job = newJob(SimpleRecoveryStatefulJob_Offcial.class).withIdentity("job_" + count, schedId) // put triggers in group named
  ...
  public static void main(String[] args) throws Exception {
    ...
    ClusterExample_Offcial example = new ClusterExample_Offcial();
